set overlay_name "hdmi_passthrough_vdma_aud"
...
# 
import_files -norecurse ./src/sw/Passthrough_Microblaze_1.elf
set_property used_in_simulation 0 [get_files -all ${overlay_name}/${overlay_name}.srcs/sources_1/imports/sw/Passthrough_Microblaze_1.elf]
set_property SCOPED_TO_REF mb_system_bd [get_files -all -of_objects [get_fileset sources_1] {proj_1/proj_1.srcs/sources_1/imports/sw/Passthrough_Microblaze_1.elf}]
set_property SCOPED_TO_CELLS { microblaze_0 } [get_files -all -of_objects [get_fileset sources_1] {proj_1/proj_1.srcs/sources_1/imports/sw/Passthrough_Microblaze_1.elf}]
